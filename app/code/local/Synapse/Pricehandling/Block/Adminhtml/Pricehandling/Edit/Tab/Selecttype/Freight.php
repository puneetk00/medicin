...
class Synapse_Pricehandling_Block_Adminhtml_Pricehandling_Edit_Tab_Selecttype_Freight
...
implements Varien_Data_Form_Element_Renderer_Interface
{
    ...
    {
        $this->setTemplate('pricehandling/freight.phtml');
    }
	...
	public function getValues()
    {
         ...
         $values = array();
         $data = Mage::getModel("pricehandling/freight")->getCollection()->addFieldToSelect("*")->addFieldToFilter("charge_id", $filter);
